...
$current = 0;
$karyawanArr = array();
$div_value = "14"; //id divisi

$kar_tampil_div_in = $ms->ms_tampil_div_in_new($div_value);
...
while($kar_data_div_in = mysql_fetch_assoc($kar_tampil_div_in)){
    ...
    $SIPEMA_url = "http://103.86.160.10/sipema/sipema_data_ms.php";
    ...
    if($kar_data_div_in['div_id']==14){
        $identifyMS = "_MS";
    }else{
        $identifyMS = "";
    }
    
    $divisi = $kar_data_div_in['div_id'].$identifyMS;
    $bdc = $BDC_datares;
