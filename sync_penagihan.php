...
$datenya = date('Y-m-d');
// $datenya = '2021-08-01'; // Manual buat ngambil tanggal tertentu
...
while($kar_data_div_in = mysql_fetch_assoc($kar_tampil_div_in)){
    ...
    $PENAGIHAN_url = "http://103.86.160.10/sipema/sumperolehan/hereg_harian_rm.php?detail=1&grouping=1&detailmhs=1&rawdata=1&tgl=".$datenya;
