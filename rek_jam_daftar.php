...
foreach($loop_data as $k => $v) {
	...
	$isi .= '<td>'.array_sum($v['total']).'</td>'; // td buat jumlah
...
<html lang="en">
<head>
  <title>Monitoring Trafik Pencapaian</title>
  <meta charset="utf-8">
  ...
  <title>Monitoring Trafik Pencapaian Closing</title>
  <style>
        .sticky-offset {
            /* top: 35px !important; */
        }
...
<body>
  <div class="container-fluid p-0 p-lg-2">
	<nav class="navbar navbar-expand-md navbar-dark heading bg-dark rounded">
		<a class="navbar-brand" href="#">Rekap Jam Daftar Closing PMB</a>
