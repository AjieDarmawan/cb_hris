			  ...
			  <tr>
			    ...
			    <td>
					<div >
						<b>
						<?php 
							echo cek_div($fpk_data_id['fpk_div2']);
						?>
						</b>
					</div>
			    </td>
		  ...
		  <div id="aspek_5<?php //echo $fpk_data_asp['fpk_asp_id']; ?>" 
		    ...
		    <div class="panel-body" >
			  ...
			  <tbody>
				  ...
				  <td> <b> Bogor , <?php echo date('d M Y ',strtotime($tgl_berlaku)) ;?> </b> </td>
				  </tr>
...
?>		
		<em>
		<u>Catatan xxxx :</u><br />
		1) Surat <?php echo $fpk_data_id['fpk_jenis'];?> Tugas  ini  dibuat  u/Ybs, sesuai arahan dan hasil rapat Pimpinan dengan Jajaran Dewan Direksi.<br />
		2) <?php echo $fpk_data_id['fpk_jenis'];?> Tugas ini dikeluarkan, lebih kearah optimalisasi SDM di bidang promosi/marketing  dan tertib administrasi lainnya.<br />
		3) <?php echo $fpk_data_id['fpk_jenis'];?> Tugas ini u/Ybs, efektif  diberlakukan sejak tanggal,  <strong><?php echo date('d-m-Y ',strtotime($tgl_berlaku)) ;?></strong>
