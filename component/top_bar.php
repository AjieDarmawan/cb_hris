<header class="main-header"> 
    ...
    data-intro="Hello, <strong><?php echo $kar_data['kar_nm']?></strong><br> Selamat datang  di Gilland Ganesha Absen,
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">         		  
		  <li class="find-people visible-lg-block"><form action="" method="post"><button type="submit" name="bsignout" class="btn btn-danger btn-flat">Sign out</button></form> </li>
    ...
    data-intro="Hello, <strong><?php echo $kar_data['kar_nm']?></strong><br> Selamat datang  di Gilland Ganesha Absen,
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
        <li class="find-people visible-lg-block">
        ...
        <?php //}?>
          ...
          <!-- Notifications Cuti-Menu -->
          <li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-calendar" title="Cuti"></i>
            <?php
            ...
            ?>  
            <span class="label label-danger"><?php echo $ntf_data_sts_cek;?></span>
            <?php }?>
            </a>
            <ul class="dropdown-menu">
              ...
              <li> 
                ...
                <ul class="menu">
                  ...
                  $ntf_data_tampil_limit=$cti->cuti_ntf_data_tampil_limit($ntf_data_tujuan);
          ...
          $icon_="<i class='fa fa-user text-primary'></i>";
      ...
      //////////////////////////////
                    ?>"><a href="<?php echo $url; ?>"> <?php echo $icon_; ?> <strong><?php echo $data['ntf_data_act']; ?></strong> - <?php echo strip_tags(substr(str_replace('"','',$data['ntf_data_isi']),0,35));?> <?php echo $text_ntf;?> </a> </li>
          
                  <?php }}?>
                </ul>
              </li>
              <li class="footer"><a href="?p=cuti_notifikasi">View all</a></li>
            </ul>
          </li>
              ...
              <li> 
                ...
                <ul class="menu">
                  ...
                  foreach($ntf_data_tampil_limit as $data){
                    ...
                    $pos_act = strpos($data['ntf_data_act'],'Eva.KPI');
                    
                    if($data['ntf_data_act'] == "Form Penilaian Kerja" ||
                       $data['ntf_data_act'] == "Hasil Penilaian Kerja" ||
                       $data['ntf_data_act'] == "Approval Penilaian Kerja" ||
                       $data['ntf_data_act'] == "Penilaian Kerja Penilai 1" ||
                       $data['ntf_data_act'] == "Penilaian Kerja Penilai 2" ||
                       $pos_act !== false){
          ...
          <li class="dropdown user user-menu"> 
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header"> <img src="module/profile/img/<?php
                ...
                <p> <?php echo $kar_data['kar_nm'];?><?php echo $kar_datatst['kar_nm'];?> <br> <small><?php echo $kar_data['jbt_nm'];?></small></p>
              </li>
              <!-- Menu Body -->
              <!-- <li class="user-body">
