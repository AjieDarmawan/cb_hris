...
$page = "rekap_simulasi_new_reward_xxajitest.php";
...
if(!empty($_SESSION['fday']) &&
   ...
   !empty($_SESSION['fdivisi'])){
    ...
    if($_SESSION['fdivisi'] == "unit"){
		...
		AND a.kar_nik IN ('SG.0357.2016','SG.0609.2021','SG.0143.2013','SG.0637.2021','SG.0596.2021','SG.0615.2021','SG.0384.2017')
        ...
        while($data = mysql_fetch_assoc($query)){
			...
			echo "<pre>".print_r($SIPEMA_datares,1)."</pre>";
            ////////////////////////////////////////////////////////////////////////////////////////////////
