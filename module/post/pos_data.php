...
<?php 
  ...
  require('module/post/pos_act.php'); 
                  ...
                  <tr>
                    ...
                    <?php }}?>
                        ...
                        <a  href='javascript:;'
                          data-aksi='UpdatePOS'
                          data-edit='Edit'
                          data-id='<?php echo $data['pos_id'];?>'
                          data-toggle='modal' data-target='#editpos' title="Edit Barang">
                          <span style='cursor:pointer' class='btn btn-primary btn-xs'>
...
<div id="editbrg" class="modal fade" tabindex="-1" role="dialog" 
    aria-labelledby="myModalLabel" aria-hidden="true">
</div>

<div id="editpos" class="modal fade" tabindex="-1" role="dialog" 
  aria-labelledby="myModalLabel" aria-hidden="true">
</div> 
...
$(document).ready(function () {
      ...
      $('#editpos').on('show.bs.modal', function (event) {
       // alert('editpost');
        ...
        var id   = div.data('id');
        var edit = div.data('edit');
        $.ajax({
               url: "module/post/akt_edit_pic.php",
               async: false, // makes request synchronous //
               type: "GET",
               data : {id: id, aksi: aksi, edit: edit},
               success: function (ajaxData){
                    $("#editpos").html(ajaxData);
