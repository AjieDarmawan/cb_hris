<?php require('module/account_ms/acc_act.php'); ?>
				...
				?>
                  <tr>
                    ...
                    if(!empty($data['acc_sts'])){
                      if($data['acc_sts']=="A"){
                    ?>
                    <a href="#block-confirm" data-toggle="modal" data-data="<h4>Yakin Akun <strong><?php echo $data['acc_username'];?></strong> akan di BLOCK?</h4>" data-url="?p=account_marketing_support&act=block&id=<?php echo $data['acc_id'];?>"><span style="cursor:pointer" class="label label-success"><i class="fa fa-check"></i></span></a>
                    <?php 
                    }elseif($data['acc_sts']=="N"){
                    ?>
                    <a href="#block-confirm" data-toggle="modal" data-data="<h4>UNBLOCK Akun <strong><?php echo $data['acc_username'];?></strong></h4>" data-url="?p=account_marketing_support&act=unblock&id=<?php echo $data['acc_id'];?>"><span style="cursor:pointer" class="label label-danger"><i class="fa fa-ban"></i></span></a>
                    <?php }}?>
                    <a href="#delete-confirm" data-toggle="modal" data-data="<?php echo $data['acc_username'];?>" data-url="?p=account_marketing_support&act=hapus&id=<?php echo $data['acc_id'];?>"><span style="cursor:pointer" class="label label-danger"><i class="fa fa-trash"></i></span></a>
                    </td>
                  </tr>
                <?php }}?>  
                </tbody>      
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-globe"></i> Tambah Account</h4>
      </div>
      ...
      <div class="modal-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" name="kar_id" id="kar_id_ms" required>
              	<option value="" selected></option>
                <?php
				$kar_tampil=$ms->ms_tampil();
				foreach($kar_tampil as $data){
                                    $kar_id=$data['kar_id'];
                                    $acc_tampil_kar=$acc->acc_tampil_ms_kar($kar_id);
          ...
          <center><div id="kar_data"></div></center>
          <div class="form-group">
