...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="?p=management_asset">Management Asset</a></li>
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title"><?php echo $ast_jns_data['ast_jns_nm'];?></h3>
        ...
        <table id="tb_karyawan" class="table table-bordered table-striped table-hover">
            ...
            <tbody>
            <?php
            while($data=mysql_fetch_array($ast_tampil_jns_id)){
...
<div class="modal fade" id="inputasset" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <input type="hidden" name="ast_jns_id" id="ast_jns_id" value="<?php echo $ast_jns_data['ast_jns_id']; ?>">
