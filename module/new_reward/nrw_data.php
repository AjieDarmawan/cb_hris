<?php require('module/new_reward/nrw_act.php'); ?>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <table id="tb_new_reward" class="table table-hover table-striped table-bordered nowrap" style="width:100%">
            <thead>
	      <tr>
                ...
                <th style="text-align: center;">TCM</th>
                <th  style="text-align: center;">REG</th>
                <th  style="text-align: center;">REG PTS</th>
                <th  style="text-align: center;">REG HER</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: right;"><?php echo $val['jml_reg_pts'];?></td>
