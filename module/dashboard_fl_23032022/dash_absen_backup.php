<!-- general form elements -->
			...
			<br><br>
	                <?php }}?>   
	                    ...
	                    ?>
	                    	<button type="submit" name="babspulangmalam" class="btn btn-success btn-lg"><i class="fa fa-sign-out"></i> Absen Pulang <br><small><small><small>Khusus Shift Malam</small></small></small></button>
                  ...
                  <div class="box-footer">
					...
					while($data=mysql_fetch_array($abs_tampil_kar)){
					  ...
					  if($data['abs_sts']=="P"){
					    ...
					    if($since_start->h < 8){
						    echo"<small>Kurang Dari 8 Jam,</small> Grade: <span class='label label-danger'>Bad</span>";
					    }elseif($since_start->h > 8){
						    echo"<small>Lebih Dari 8 Jam,</small> Grade: <span class='label label-success'>Good</span>";
					    }elseif($since_start->h = 8){
						    echo"<small>8 Jam,</small> Grade: <span class='label label-primary'>Mediocre</span>";
					    }
					  }
  ...
  <div class="modal-dialog modal-lg"> <!--modal-lg-->
    <div class="modal-content">
      <div class="modal-header bg-primary">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-map-marker"></i> Pilih <strong>Kantor</strong> / <strong>Unit</strong> dimana Anda akan melakukan <strong>Absen Masuk</strong></h4>
      </div>
      <form class="form-horizontal" action="" method="post" id="myform_1">
		  ...
		  <div class="col-sm-10">
			...
			$ktr_tampil=$ktr->ktr_tampil();
					if($ktr_tampil){
						 ...
						 if(($data['ktr_id']!=="44")&&($data['ktr_id']!=="23")&&($data['ktr_id']!=="22")&&($data['ktr_id']!=="51")&&($data['ktr_id']!=="11")&&($data['ktr_id']!=="20")&&($data['ktr_id']!=="28")&&($data['ktr_id']!=="26")&&($data['ktr_id']!=="34")){
		    ?>
	       ...
	       <div class="modal-footer">
		    <div class="alert alert-warning  alert-dismissable" align="left">
		       ...
		       <strong>Absensi via WebCam</strong> masih dalam tahap uji coba. Posisi kamera <strong>disebelah kiri</strong>.<br>
	       ...
	       <button type="button" onClick="take_snapshot_1()" class="btn btn-primary"><i class="fa fa-hand-o-up"></i></button>
	     </div>
...
<!-- Masuk Telat -->
<div class="modal fade" id="masuk_telat" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg"> <!--modal-lg-->
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-meh-o"></i> Yahh.. Kamu telat masuk <strong><?php echo $ucapan; ?></strong> ya, tulis ya alasannya.. <i class="fa fa-exclamation-triangle"></i></h4>
      </div>
      <form class="form-horizontal" action="" method="post" id="myform_2">
      <!--<form class="form-horizontal" action="" method="post">-->
      <div class="modal-body">
	...
	<div class="row">
		...
		<div class="col-sm-10">
	      ...
	      <div class="modal-footer">
		<span style="float:left;"><small>Waktu:</small> <?php echo $ucapan; ?> <br> <small>Anda Terlambat:</small> <?php echo $jam_telat; ?></span>
		<!--<button type="submit" name="babsmasuk" class="btn btn-primary"><i class="fa fa-hand-o-up"></i></button>-->
		<button type="button" onClick="take_snapshot_2()" class="btn btn-primary"><i class="fa fa-hand-o-up"></i></button>
	      </div>
...
<!-- Pulang Cepat -->
<div class="modal fade" id="pulang_cepat" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-red">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-meh-o"></i> Hayoo, baru jam segini ko udah mau pulang <strong><?php echo $shift; ?></strong>.. <i class="fa fa-exclamation-triangle"></i></h4>
      </div>
      <form class="form-horizontal" action="" method="post">
      <div class="modal-body">
          <div class="form-group">
      ...
      <div class="modal-footer">
        <span style="float:left;"><small>Waktu:</small> <?php echo $shift; ?> <br> <small><?php echo $message; ?></small> </span> <button type="submit" name="babspulang" class="btn btn-danger"><i class="fa fa-hand-o-up"></i></button>
      </div>
      </form>
    </div>
  </div>
