...
<input type="hidden"  name="p" value="<?php echo $_REQUEST['p'] ; ?>"    >
    ...
    <section class="content-header">
		  ...
		  ?>		    
	       <?php if(  $kar_id=="0248"  || $kar_id=="0499"  || $kar_id == "0447" || $kar_id == "0551"  || $kar_id == "0037" ){ ?>	  
 ...
 <div class="col-lg-12 connectedSortable ">  
        ...
        <div class="box-body table-responsive"> <!--table-responsive-->
			  ...
			  style="font-size:14px;font-weight: normal;">
				...
				if 	($kar_id==248 || $kar_id==13 || $kar_id==499 || $kar_id==447 ||  $kar_id == 430 || $kar_id == 535 || $kar_id == 37) {
				    $filter_nik = "";
				}else{
...
*/						   		 
                    ...
                    <td align="left">
					<?php 
					 if ($kar_id==499 || $kar_id==447 || $kar_id==248 || $kar_id==37) { 
					?>
