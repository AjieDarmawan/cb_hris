...
<style>
    ...
    <section class="content-header">
      ...
      <h1> Input Data Pengajuan Cuti <?php //echo 'Form Cuti Karyawan : Pengajuan ' //$title;?> <small></small> </h1>
  ...
  for ($i=0 ;$i < 12;$i++){ 
    ...
    if ($i==$jml_data){
	    echo '<div class="form-group"> 
			 ...
			 <label class="control-label col-sm-8" style="color:red;text-align:left ">
			  	<em>
				CUTI BERAKHIR BULAN MARET 2021 : Pengajuan Cuti Baru - Input :  TglCuti, Keterangan, Nama Atasan (Wajib diisi)
				</em>
			  </label>
			</div>';
	}	
			...
			<?php
			 ...
			 ?>
			  <option value="<?php echo $row['kar_id'];?>" <?php echo $selected; ?> <?php //echo $xdisabled;?> >
				<?php echo $row['kar_nm'] ; //$row['kar_nik'].' - '.$row['kar_nm'];?>
			  </option>
			  <?php 
			  	}
			  //	}
