<?php require('module/reward/rwd_act.php'); ?>
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1> <?php echo $title;?> <small>H-1</small> </h1>
      <ol class="breadcrumb">
    ...
    <section class="content"> 
      ...
      <div class="row">
        <div class="col-xs-12">
		  ...
		  ?>
		  <div class="input-group">
		    <button class="btn btn-success btn-flat" type="button" id="btn_sinkronisasi" <?php echo $disabled_sync;?>>Sinkronisasi</button>
		  ...
		  <?php }else{
		    ...
		    <th rowspan="2" style="text-align: center; vertical-align: middle;">Non Her Reg<br><em>(last month)</em></th>
		  ...
		  foreach($dataArr1 as $key=>$val){
		    ...
		    $reward = $val['reward'] + $dataArr2[$key]['reward_last'];
		    ...
		    if($reward >= 25){
		      $data_rwd1 = $val['reward'] * 35000;
		      $data_rwd2 = $dataArr2[$key]['reward_last'] * 10000;
		      $rumus =  $data_rwd1 + $data_rwd2;
			...
			if($admfield){
				$karnik_syn = $nik;
				$act_admin = " <button id=\"btn_".$karnik_syn."\" title=\"Sinkronisasi\" class=\"admfield btn btn-xs btn-success\" onclick=\"___synperkar('".$karnik_syn."');\"><i class=\"fa fa-exchange\"></i></button>";
		  ...
		  <tr>
		    ...
		    <td style="text-align: right"><a href="javascript:;"
                        data-action="Non Her Reg (last month)"
			data-nik="<?php echo $niknya;?>"
			data-nama="<?php echo $nama;?>"
			data-source="<?php echo $dataArr2[$key]['noherregis_mhs_last'];?>"
			data-toggle="modal" data-target="#view_pencapaian" ><?php echo $dataArr2[$key]['noherregis_last'];?></a></td>
			...
			data-toggle="modal" data-target="#view_pencapaian" ><?php echo $reward;?></a></td>
