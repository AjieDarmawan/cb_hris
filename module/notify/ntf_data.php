<?php 
    error_reporting(0);
	require('module/notify/ntf_act.php'); 
?>
<!-- Content Header (Page header) -->
		...
		$ntf_data_tujuan=$kar_id;
                $ntf_data_tampil=$ntf->ntf_data_tampil($ntf_data_tujuan);
                if($ntf_data_tampil){
		  ...
		  if($data['ntf_data_sumber']=="SYSTEM"){
		    ...
		    ?>
                    ...
                    <td><a href="<?php echo $data['ntf_data_url']; ?>"><strong><?php echo $data['ntf_data_act']; ?></strong> - <?php echo $data['ntf_data_isi']; ?></a></td>
