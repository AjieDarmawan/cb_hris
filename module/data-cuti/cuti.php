    ...
    <section class="content-header">
		  ...
		  ?>		    
		   ...
		   <a href="?p=cuti" class='btn btn-primary'><i class="fa fa-refresh"></i>&nbsp; </a>
			...
			<span>
			<input type="text" name="jdw_bulan" class="form-control dpmonth2" 
				id="jdw_bulan" value="<?php echo $jdw_bulan?>" style="width:100px" placeholder="Bulan"   >	
		
			<button type="submit"  style="width:100px" name="bsave" class="btn btn-primary ">
        ...
        <div class="box-body table-responsive"> <!--table-responsive-->
			  ...
			  style="font-size:14px;font-weight: normal;">
				...
				if 	($kar_id==13 || $kar_id==499 || $kar_id==447 ||  $kar_id == 430 || $kar_id == 542 || $kar_id == 535 || $kar_id == 551 || $kar_id == 37 || $kar_id==246 )
				{
				     $filter_nik = "";
				     if ($blnthn <> '-'){
				     	$filter_bulan = " AND LOCATE('$blnthn', e.datacuti)";
				     }
				...
				$sql  =" SELECT 
						...
						WHERE b.kar_dtl_sts_krj='A' and kar_dtl_typ_krj <> 'Resign'  $filter_nik $filter_bulan
