...
<!--	
    <div style=" margin-left:175px; margin-top:-515px"></div>
 	...
 	<div style=" margin-left:160px; margin-top:6px">&nbsp;<?php echo  $aKET; ?></div>
	
 	<div style=" margin-left:160px; margin-top:25px">&nbsp;</div>
 	<div style=" margin-left:175px; margin-top:13px"><em><font size="+1"> &radic; </font></em></div>

	
    <div style=" margin-left:120px; margin-top:10px; ">&nbsp;</div>
    <div style=" margin-left:120px; margin-top:0px;  position:fixed">&nbsp;</div>
	
 	<div style=" margin-left:120px; margin-top:0px">&nbsp;<?php echo date('F',strtotime($xtgl)); ?></div>
