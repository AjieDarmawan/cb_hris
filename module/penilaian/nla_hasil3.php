...
<?php if($fpk_cek_id > 0 && $kar_id==$fpk_data_id['fpk_mengetahui3']){?>
<!-- Content Header (Page header) -->
	...
	<hr>
	  ...
	  <!-- info row -->
	      ...
	      if($fpk_data_id['fpk_sts']=="Z"){
	      ?>
	      <button type="submit" name="bapproved3" class="btn btn-success pull-right" <?php echo $done2;?>><i class="fa fa-thumbs-up"></i> Approved</button>
	      <?php }else{?>
	      <button type="submit" name="bapproved3" class="btn btn-success pull-right" <?php echo $konfirm;?>><i class="fa fa-thumbs-up"></i> Approved</button>
	      <?php }?>
