...
<!-- Content Header (Page header) -->
	...
	<br>
	      ...
	      <a class="btn btn-success" disabled><i class="fa fa-thumbs-up"></i> Approved</a>
              </div>
	      <?php }else{?>
	      <a href="print_nla.php?to=prt&id=<?php echo md5($fpk_data_id['fpk_kd']); ?>" target="_blank" class="btn btn-default" disabled><i class="fa fa-print"></i> Print</a>
              <div class="pull-right">
              <!--<a href="print_pdf.php?to=pdf&id=<?php echo md5($fpk_data_id['fpk_kd']); ?>" class="btn btn-primary" target="_blank" disabled><i class="fa fa-download"></i> Generate PDF</a>-->
              </div>
	      <?php }?>
            </div>
          </div>
