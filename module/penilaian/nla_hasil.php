...
<!-- Content Header (Page header) -->
      ...
      <!-- Main content -->
		...
		echo $fpk_data_mengetahui3['kar_nm'];
	      ...
	      <br>
			...
			if(($fpk_data_id['fpk_sts']=="W") || ($fpk_data_id['fpk_sts']=="Z")){
	...
	<hr>
	  ...
	  <!-- info row -->
	      ...
	      if(($fpk_data_id['fpk_sts']=="W") || ($fpk_data_id['fpk_sts']=="Z")){
	      ?>
	      <button type="submit" name="bapproved" class="btn btn-success pull-right" <?php echo $done;?> <?php echo $done2;?>><i class="fa fa-thumbs-up"></i> Approved</button>
	      <?php }else{?>
