...
$fpk_mengetahui3=$_POST['fpk_mengetahui3'];
...
if(isset($_POST['bsave'])){
  ...
  if($fpk_insert){
    ...
    $ntf_isi=$fpk_id.'*%#'.$fpk_keterangan.'*%#'.$fpk_penilai.'*%#'.$fpk_mengetahui.'*%#'.$fpk_mengetahui2.'*%#'.$fpk_mengetahui3.'*%#'.$kar_id_.'*%#'.$fpk_kd.'*%#'.$fpk_sesi;
...
if(isset($_POST['bsendupdate'])){
  ...
  if($fpk_update){
    ...
    $ntf_act="Konfirm Penilaian Kerja";
    ...
    $ntf_data_url="?p=hasil_penilaian2&act=open&id=".md5($fpk_kode); //URL Disesuaikan
...
if(isset($_POST['bapproved'])){
   ...
   $fpk_approve3=$fpk_data_id['fpk_mengetahui3'];

   $fpk_penilai_=$fpk_data_id['fpk_penilai'];

  // $fpk_sts="Z"; //status X,Y,Z  X=Proses. Y=Lock. Z=Approved
  $fpk_sts="W"; //status X,Y,Z  X=Proses. Y=Lock. Z=Approved
  ...
  if($fpk_update_sts){
    ...
    $ntf_isi=$fpk_id.'*%#'.$fpk_sts.'*%#'.$fpk_approve3.'*%#'.$fpk_kode.'*%#'.$fpk_penilai_;
    ...
    $ntf_data_url="?p=hasil_penilaian3&act=open&id=".md5($fpk_kode); //URL Disesuaikan

    $ntf_data_tujuan=$fpk_approve3; //Semua Tujuan = ALL
...
if(isset($_POST['bapproved3'])){

   $fpk_id=$fpk_data_id['fpk_id'];

   $fpk_kode=$fpk_data_id['fpk_kd'];

   $fpk_approvel=$fpk_data_id['fpk_mengetahui3'];
  ...
  if($fpk_update_sts){
    ...
    $ntf_data_url="?p=form_penilaian&act=open&id=".md5($fpk_kode); //URL Disesuaikan
...
if(isset($_POST['btambah'])){
   ...
   $rkm_sanksi=$_POST['rkm_sanksi'];

   $rkm_pelapor=$_POST['rkm_pelapor'];

   $rkm_tgl=$_POST['rkm_tgl'];
   
   $rkm_tgl_akhir=$_POST['rkm_tgl_akhir'];

   

   $rkm_insert=$nla->rkm_insert($rkm_nilai,$rkm_keterangan,$rkm_sanksi,$rkm_pelapor,$rkm_tgl,$rkm_tgl_akhir,$kar_id_);
...
if(isset($_POST['bedit_rekamjejak'])){
  ...
  $rkm_update=$nla->rkm_update($rkm_id,$rkm_nilai,$rkm_keterangan,$rkm_sanksi,$rkm_pelapor,$rkm_tgl,$rkm_tgl_akhir);
...
$kar_tampil_drt=$kar->kar_tampil_drt(); 
