<?php require('module/account/acc_act.php'); ?>
				...
				?>
                  <tr>
                    ...
                    if(!empty($data['acc_sts'])){
                      if($data['acc_sts']=="A"){
                    ?>
                    <a href="#block-confirm" data-toggle="modal" data-data="<h4>Yakin Akun <strong><?php echo $data['acc_username'];?></strong> akan di BLOCK?</h4>" data-url="?p=data_account&act=block&id=<?php echo $data['acc_id'];?>"><span style="cursor:pointer" class="label label-success"><i class="fa fa-check"></i></span></a>
                    <?php 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" name="kar_id" id="kar_id" required>
