...
$p2_ditetapkan = "disabled";
$p2_tanggal = "readonly";

if($kpi_cek_id > 0 && $kar_id==$kpi_data_id['kpi_penilai2']){
  
if($kpi_data_id['kpi_sts']=='Y'){
  $p2_readonly = "";
  $p2_disabled = "";
}else{
  $p2_readonly = "readonly";
  $p2_disabled = "disabled";
}
  ...
  <section class="invoice col-md-7">
	...
	<address>
	  <div class="form-group">
	    ...
	    <div class="col-md-12">
	      <input type="text" name="kpi_tanggal" class="form-control" id="kpi_tanggal" value="<?php echo $kpi_data_id['kpi_tanggal'];?>" placeholder="Tanggal Penilaian" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask style="width:182;" required <?php echo $p2_tanggal;?>>
	    </div>
	  </div>
		...
		<tbody>
		    ...
		    for($i=0;$i<count($exp1);$i++){
			  ...
			  if($bdc_cek !== false) {
			    ...
			    $kps_aktual2 = '<input type="text" class="form-control" name="kpi_data2['.$no.']" value="'.$exp2[5].'" style="width:60px;" data-max="'.$kpi_sasaran_data['kps_target'].'" onkeyup="cekMax(this)" required '.$p2_readonly.'>';
			    ...
			    $kps_aktual2 = '<select class="form-control" name="kpi_data2['.$no.']" style="width:60px;" required '.$p2_disabled.'>';
	...
	<div class="table-responsive">
		...
		?>
		<input type="radio" name="kpi_ditetapkan" value="<?php echo $value;?>" class="flat-red" id="kpi_ditetapkan" checked <?php echo $p2_ditetapkan;?>/> <?php echo $caption;?><br>
		<?php }else{?>
		<input type="radio" name="kpi_ditetapkan" value="<?php echo $value;?>" class="flat-red" id="kpi_ditetapkan" <?php echo $p2_ditetapkan;?>/> <?php echo $caption;?><br>
		<?php }}?> 
	...
	<div class="table-responsive">
	  ...
	  ?>
	  <textarea name="kpi_saranperbaikan" class="form-control" <?php echo $p2_ditetapkan;?> ><?php echo $kpi_data_id['kpi_saranperbaikan'];?></textarea>
	  <?php }?>
	</div>
    ...
    <div class="row no-print">
      <div class="col-md-12">
	<button name="bsendupdate2" class="btn btn-success pull-right <?php echo $p2_disabled;?>"><i class="fa fa fa-send"></i> Simpan & Kirim</button>
      </div>
    </div>
