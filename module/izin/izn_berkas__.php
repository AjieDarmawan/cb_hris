	    ...
	    <div class="col-sm-7 invoice-col">
          ...
          <div class="row">
	        ...
	        <input type="hidden" id="kar_nik" value="<?php echo $kar_data_['kar_nik']; ?>">	
				...
				<div class="form-group">
				  <label for="izn" class="col-md-12 col-md-6 control-label">Waktu</label>
				  <div class="col-md-12 col-md-6 bootstrap-timepicker">
					<input name="izn_waktu1" type="text" value="<?php echo $kpi_data_id['izn_waktu1']; ?>"  data-default-time="00:00:00" class="form-control " readonly>  s/d
					<input name="izn_waktu2" type="text" value="<?php echo $kpi_data_id['izn_waktu2']; ?>" data-default-time="00:00:00" class="form-control " readonly>
				  </div>
				</div>
				<div class="form-group">
				  <label for="izn" class="col-md-12 col-md-6 control-label">Durasi</label>
				  <div class="col-md-12 col-md-6">
					<input type="text" name="izn_durasi" class="form-control" id="izn_durasi" value="<?php echo $kpi_data_id['izn_durasi']; ?>"  placeholder="Durasi"  data-mask style="width:182;" readonly>
				  </div>
				</div>
				<div class="form-group">
				  <label for="izn" class="col-md-12 col-md-6 control-label">Alasan</label>
				  <div class="col-md-12 col-md-6">
					<input type="checkbox" name="izn_jenis" class="minimal-red" value="Sakit" readonly <?php echo $checked_sakit;?> > &nbsp;<strong>Sakit</strong><br>
					<input type="checkbox" name="izn_jenis" class="minimal-red" value="Sebar Brosur" readonly <?php echo $checked_sebarbrosur;?>> &nbsp;<strong>Sebar Brosur</strong><br>
					<input type="checkbox" name="izn_jenis" class="minimal-red" value="Kunjungan Marketing" readonly <?php echo $checked_kunjungan;?>> &nbsp;<strong>Kunjungan Marketing</strong><br>
					<input type="checkbox" name="izn_jenis" class="minimal-red" value="Keluarga Inti Sakit" readonly <?php echo $checked_keluargaskt;?>> &nbsp;<strong>Keluarga Inti Sakit</strong><br>
					<input type="checkbox" name="izn_jenis" class="minimal-red" value="Keluarga Inti Meninggal" readonly <?php echo $checked_keluargaintmngt;?>> &nbsp;<strong>Keluarga Inti Meninggal</strong><br>
				  </div>
				</div>
				<div class="form-group">
				  <label for="izn" class="col-md-12 col-md-6 control-label">Alasan Lain</label>
				  <div class="col-md-12 col-md-6">
					<textarea type="textarea" name="izn_keterangan" class="minimal-red" readonly> <?php echo $kpi_data_id['izn_keterangan']; ?></textarea>
...
<hr>
	...
	<div class="pull-right">
	  ...
	  <button name="notpproved" class="btn btn-danger pull-right" disabled><i class="fa fa-thumbs-down"></i> TIDAK</button>
	</div>
	<?php }?>
      </div>
    </div>
