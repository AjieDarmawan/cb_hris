...
$kar_dtl_tgl_sk=$_POST['kar_dtl_tgl_sk'];
$kar_dtl_tgl_joi2=$_POST['kar_dtl_tgl_joi2'];
$kar_dtl_als_res_md=$_POST['kar_dtl_als_res_md'];
...
$kar_dtl_agama=$_POST['kar_dtl_agama'];
$kar_dtl_tgl_lahir=$_POST['kar_dtl_tgl_lahir'];
$kar_dtl_ibu_kandung=$_POST['kar_dtl_ibu_kandung'];
...
$kar_dtl_tlp_marketing=$_POST['kar_dtl_tlp_marketing'];
...
if(isset($_POST['bsave'])){
	if($kar_data['kar_nik']==$kar_nik){
		...
		$kodeawalnew = "GG";			
		$tgllahirnya  = $kar_tgl_lahir;
		$pecahtgllahir = explode("-", $tgllahirnya);
		$tahunbelakang = substr($pecahtgllahir[0],-2);
		$kar_nik_new = $kodeawalnew . "." .$kd_tahun. "."  .$pecahtgllahir[2].$pecahtgllahir[1].$tahunbelakang;

		$kar_insert=$kar->kar_insert($kar_nik,$kar_nm,$kar_tgl_lahir,$div_id,$jbt_id,$lvl_id,$unt_id,$ktr_id,$kot_id,$pt_id,$kar_nm_panggilan,$kar_nik_new);

		//Notify
		$ntf_id=mysql_insert_id();
		$ntf_act="Tambah Karyawan";
        $ntf_isi=$kar_id.'-'.$ntf_id.'-'.$kar_nik.'-'.$kar_nm.'-'.$kar_tgl_lahir.'-'.$jbt_id.'-'.$ktr_id.'-'.$kot_id.'-'.$pt_id.'-'.$kar_nik_new;
        $ntf_ip=$ip_jaringan;
        $ntf_tgl=$date;
        $ntf_jam=$time;
        $ntf_insert=$ntf->ntf_insert($ntf_act,$ntf_isi,$ntf_ip,$ntf_tgl,$ntf_jam,$kar_id);
        //End Notify
		//tambahan karena ga masuk ke detail
		$kar_insert_detail=$kar->kar_insert_detail($kar_dtl_tgl_lahir,$ntf_id);
		//tambahan karena ga masuk ke detail
		if($kar_insert){
...
elseif(isset($_POST['bupdate'])){
	$kar_update=$kar->kar_update($kar_id_,$kar_nm,$kar_tgl_lahir,$div_id,$jbt_id,$lvl_id,$unt_id,$ktr_id,$kot_id,$pt_id,$kar_nm_panggilan);

	//Notify
	$ntf_id=$kar_id;
	$ntf_act="Update Karyawan";
    $ntf_isi=$ntf_id.'-'.$kar_nm.'-'.$kar_tgl_lahir.'-'.$jbt_id.'-'.$ktr_id.'-'.$kot_id.'-'.$pt_id.'-'.$kar_nm_panggilan;
    $ntf_ip=$ip_jaringan;
    $ntf_tgl=$date;
    $ntf_jam=$time;
    $ntf_insert=$ntf->ntf_insert($ntf_act,$ntf_isi,$ntf_ip,$ntf_tgl,$ntf_jam,$kar_id);
...
if(isset($_POST['bupdate_employee'])){
		...
		if($kar_cek_detail > 0){
			$kar_update_employee=$kar->kar_update_employee($kar_dtl_sts_krj,$kar_dtl_typ_krj,$kar_dtl_tgl_joi,$kar_dtl_msa_krj,$kar_dtl_tgl_ttp,$kar_dtl_tgl_sk,$kar_dtl_tgl_res,$kar_dtl_als_res,$kar_dtl_tgl_joi2,$kar_dtl_als_res_md,$kar_id_);
		}else{
			$kar_update_employee=$kar->kar_insert_employee($kar_dtl_sts_krj,$kar_dtl_typ_krj,$kar_dtl_tgl_joi,$kar_dtl_msa_krj,$kar_dtl_tgl_ttp,$kar_dtl_tgl_sk,$kar_dtl_tgl_res,$kar_dtl_als_res,$kar_dtl_tgl_joi2,$kar_dtl_als_res_md,$kar_id_);
		}
		...
		//BDC ACCOUNT
		$BDC_url = "http://daftarkuliah.my.id/bdc/api/inactive_user.php";
		$BDC_curl = curl_init();
		...
		//update status ggklikv2 LIVE AI
		$GGKLIKLIVEAI_URL = "https://cb.web.id/ggklikv2/api/deletekaryawanresign";
		$GGKLIKLIVEAI_curl = curl_init();
		curl_setopt_array($GGKLIKLIVEAI_curl, array(
		        CURLOPT_URL => $GGKLIKLIVEAI_URL,
		        CURLOPT_RETURNTRANSFER => true,
		        CURLOPT_ENCODING => "",
		        CURLOPT_MAXREDIRS => 10,
		        //CURLOPT_TIMEOUT => 30,
		...
		$GGKLIKLIVEAI_response = curl_exec($GGKLIKLIVEAI_curl);
		$GGKLIKLIVEAI_err = curl_error($GGKLIKLIVEAI_curl);
		curl_close($GGKLIKLIVEAI_curl);
		$GGKLIKLIVEAI_datares = json_decode($GGKLIKLIVEAI_response, true);
...
if(isset($_POST['bupdate_bio'])){
		...
		if($kar_cek_detail > 0){
			$kar_update_bio=$kar->kar_update_bio($kar_dtl_usa,$kar_dtl_gen,$kar_dtl_tmp_lhr,$kar_dtl_sts_nkh,$kar_dtl_jml_ank,$kar_dtl_tgn,$kar_dtl_agama,$kar_dtl_tgl_lahir,$kar_dtl_ibu_kandung,$kar_id_);
		}else{
			$kar_update_bio=$kar->kar_insert_bio($kar_dtl_usa,$kar_dtl_gen,$kar_dtl_tmp_lhr,$kar_dtl_sts_nkh,$kar_dtl_jml_ank,$kar_dtl_tgn,$kar_dtl_agama,$kar_dtl_tgl_lahir,$kar_dtl_ibu_kandung,$kar_id_);
		}
...
if(isset($_POST['bupdate_education'])){
		...
		if($kar_cek_detail > 0){
			$kar_update_education=$kar->kar_update_education($kar_dtl_pnd,$kar_dtl_jrs,$kar_dtl_unv_sch,$kar_dtl_sts_pnd,$kar_dtl_thn_lls,$kar_id_);
		}else{
			$kar_update_education=$kar->kar_insert_education($kar_dtl_pnd,$kar_dtl_jrs,$kar_dtl_unv_sch,$kar_dtl_sts_pnd,$kar_dtl_thn_lls,$kar_id_);
		}
...
if(isset($_POST['bupdate_card'])){
		...
		if($kar_cek_detail > 0){
			$kar_update_card=$kar->kar_update_card($kar_dtl_no_ktp,$kar_dtl_exp_ktp,$kar_dtl_no_kk,$kar_dtl_no_npw,$kar_dtl_no_kpj,$kar_dtl_no_rek,$kar_dtl_no_bpj,$kar_dtl_no_jms,$kar_id_);
		}else{
			$kar_update_card=$kar->kar_insert_card($kar_dtl_no_ktp,$kar_dtl_exp_ktp,$kar_dtl_no_kk,$kar_dtl_no_npw,$kar_dtl_no_kpj,$kar_dtl_no_rek,$kar_dtl_no_bpj,$kar_dtl_no_jms,$kar_id_);
		}
...
if(isset($_POST['bupdate_contact'])){
		...
		if($kar_cek_detail > 0){
			$kar_update_contact=$kar->kar_update_contact($kar_dtl_eml,$kar_dtl_tlp,$kar_dtl_tlp_marketing,$kar_dtl_alt,$kar_dtl_alt_dms,$kar_id_);
		}else{
			//$kar_update_contact=$kar->kar_insert_contact($kar_dtl_eml,$kar_dtl_tlp,$kar_dtl_tlp_marketing,$kar_dtl_alt,$kar_id_);
		}
...
if(isset($_POST['bupdate_jdwakses'])){
		...
		$kar_update_jdwakses = $kar->kar_update_jdwakses($kar_id_,$kar_jdw_akses);
...
if(isset($page)&&($act)){
	$kar_delete=$kar->kar_delete($kar_id_);
	echo"<script>document.location='?p=$page';</script>";
