...
<div class="row">
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<select class="form-control selectpicker" style="width: 100%;"  
				id="opr_kantor" name="kantor" data-live-search="true">
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<select class="form-control selectpicker" style="width: 100%;"
				  id="opr_kodebank" name="kodebank" data-live-search="true" >
				<option value="">- PILIH -</option>
				<?php
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="form-group">
			...
			<textarea class="form-control" rows="2" id="opr_keperluan" name="keperluan" placeholder=""></textarea>
...
<div id="item-barang"  style="display:block">
	...
	?>
	   <div class="row" >
				...
				<div class="col-md-3">
					<div class="form-group">
				<select class="form-control selectpicker" style="width: 100%;" id="opr_kodebrg_<?php echo $x; ?>"  
						name="kode_barang[]"
