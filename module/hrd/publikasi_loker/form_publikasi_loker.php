<?php require('module/hrd/publikasi_loker/act_publikasi_loker.php'); ?>
            ...
            <div class="box">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Publikasi Loker FB</h3>
                    </div>
                    ...
                    <div class="box-body">
                        <form role="form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Nama Grup FB</label>
                                <input type="text" class="form-control" required name="nama_grup" placeholder="Masukan Nama">
                            </div>
