        ...
        <div class="box-body">
          <table id="tb_history_izin" class="table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              <?php
              $pelamar_list = $pelamar->pelamar_list_interview($izn_kirim);
              $no = 1;
              ...
              ?>
                <tr>
                  ...
                  <td>
                    ...
                    if ($data_interview['status']) {
                      // echo $data_interview['status'];
                      if ($data_interview['status'] == 'gagal_interview_satu') {
                        echo "Tidak Cocok";
                      } elseif ($data_interview['status'] == 'interview_user') {
                        echo "Lanjut Interview User";
                      } elseif ($data_interview['status'] == 'skip') {

                    ?>

                        <a href="?p=pelamar_interview_proses&pelamar_id=<?php echo $data['id_pelamar']; ?>" class="btn btn-primary btn-sm">Proses</a>
