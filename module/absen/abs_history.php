...
?>
  <div class="col-lg-2 col-xs-4">   
    <div class="small-box bg-gray">
      <div class="inner">		
        <h3><?php echo $jumlahlibur;?></h3>
        <p>Libur</p>		
      </div>
      <div class="icon">
        <i class="fa fa-user-times"></i>
      </div>
      <a style="cursor:pointer;" data-toggle="<?php echo $modal;?>" data-target="#libur_modalcc" class="small-box-footer">
        More info <i class="fa fa-arrow-circle-right"></i>
      </a>
    </div>
  </div>
  ...
  <div class="col-lg-2 col-xs-4">   
    <div class="small-box bg-gray">
      <div class="inner">	
		 <?php
        $abs_abs=$abs->abs_abs($abs_tgl_masuk);
        $tidakabsen=mysql_num_rows($abs_abs);
        if($tidakabsen > 0){
          $modal="modal";
        }else{
          $modal="";
		...
		$totlib = $tidakabsen-$jumlahlibur;
        ?>
        <h3><?php echo $totlib;?></h3>
        <p>Tidak Absen</p>		
      </div>
      <div class="icon">
        <i class="fa fa-user-times"></i>
      </div>
      <a style="cursor:pointer;" data-toggle="<?php echo $modal;?>" data-target="#noabsen" class="small-box-footer">
        More info <i class="fa fa-arrow-circle-right"></i>
      </a>
    </div>
  </div>
  ...
  <div class="col-lg-2 col-xs-4">   
    <div class="small-box bg-gray">
      <div class="inner">		
        <h3><?php echo $jumlahcuti;?></h3>
        <p>Cuti</p>		
      </div>
      <div class="icon">
        <i class="fa fa-user-times"></i>
      </div>
      <a style="cursor:pointer;" data-toggle="<?php echo $modal;?>" data-target="#libur_modalcuticc" class="small-box-footer">
        More info <i class="fa fa-arrow-circle-right"></i>
      </a>
    </div>
  </div>
...
<!-- Modal No Absen -->
<div class="modal fade" id="noabsen" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-gray">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-thumbs-o-down"></i> Tidak Absen</h4>
      </div>
      <form class="form-horizontal" action="" method="post">
      <div class="modal-body" id="noabs_overflow">
          <table class="table table-bordered table-striped table-hover">
            <thead>
              <tr>
                <th>NIK</th>
...
<!-- Modal Libur -->
<div class="modal fade" id="libur_modalcc" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-gray">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-user-times"></i> Libur</h4>
      </div>
      <form class="form-horizontal" action="" method="post">
...
<!-- Modal Cuti -->
<div class="modal fade" id="libur_modalcuticc" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-gray">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-user-times"></i> Cuti</h4>
      </div>
      <form class="form-horizontal" action="" method="post">
      <div class="modal-body" id="libur_overflow">
          <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
              <?php echo $rowlistlistmodal_cuti;?>
            </tbody>      
            <tfoot>
              <tr>
                <th>NIK</th>
