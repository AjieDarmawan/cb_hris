<?php require('module/reward_ms/rwd_act.php'); ?>
		...
		<div class="col-xs-12">
			<div class="box">
			  ...
			  */
						...
						?>
							<div class="input-group">
								<button class="btn btn-success btn-flat" type="button" id="btn_sinkronisasi_ms" <?php echo $disabled_sync; ?>>Sinkronisasi</button>
					...
					<table id="tb_reward" class="table table-hover table-striped table-bordered nowrap" style="width:100%">
						<thead>
							<tr>
								...
								<th colspan="4" style="text-align: center">JUMLAH PENCAPAIAN</th>
								<th rowspan="2" style="text-align: center; vertical-align: middle;">Transaksi</th>
								<th rowspan="2" style="text-align: center; vertical-align: middle;">Insentif</th>
								<?php
								if ($admfield) {
						...
						<tbody>
							...
							foreach ($dataArr1 as $key => $val) {
								...
								for ($i = 0; $i < count($exp3); $i++) {
									...
									$exp3b = explode("#", $exp3[$i]);
									$nominal = explode(";", $exp3b[5]);
									$transaksi += $nominal[0];
									$insentif += $nominal[1];
								}
		      ...
		      $nominal = "";
								...
								if ($insentif > 0) {
									$insentif = number_format($insentif);
								} else {
									$insentif = "";
								}
								...
								if ($admfield) {
									$karnik_syn = $nik;
									$act_admin = " <button id=\"btn_" . $karnik_syn . "\" title=\"Sinkronisasi\" class=\"admfield btn btn-xs btn-success\" onclick=\"___synperkar_ms('" . $karnik_syn . "');\"><i class=\"fa fa-exchange\"></i></button>";
						...
						$act_admin = "";
							...
							?>
								<tr>
									<td><?php echo $no; ?></td>
									<td><?php echo $nik; ?></td>
									<td><a href="javascript:;" data-nama="<?php echo $nama; ?>" data-source="<?php echo $data_mhs; ?>" data-toggle="modal" data-target="#data_pencapaian"><?php echo $nama; ?></a></td>
									<td style="text-align: right" class="<?php echo $btext_red; ?>"><?php echo $bdc_data; ?></td>
									<td style="text-align: right"><a href="javascript:;" data-action="Pendaftaran" data-nik="<?php echo $niknya; ?>" data-nama="<?php echo $nama; ?>" data-source="<?php echo $pendaftaran_mhs; ?>" data-toggle="modal" data-target="#view_pencapaian"><?php echo $val['pendaftaran']; ?></a></td>
									<td style="text-align: right"><a href="javascript:;" data-action="Non Her Registrasi" data-nik="<?php echo $niknya; ?>" data-nama="<?php echo $nama; ?>" data-source="<?php echo $noherregis_mhs; ?>" data-toggle="modal" data-target="#view_pencapaian" class="<?php echo $text_red; ?>"><?php echo $val['noherregis']; ?></a></td>
									<td style="text-align: right"><a href="javascript:;" data-action="Her Registrasi" data-nik="<?php echo $niknya; ?>" data-nama="<?php echo $nama; ?>" data-source="<?php echo $herregis_mhs; ?>" data-toggle="modal" data-target="#view_pencapaian" class="<?php echo $text_red; ?>"><?php echo $val['herregis']; ?></a></td>
									<td style="text-align: right"><a href="javascript:;" data-action="Reward" data-nik="<?php echo $niknya; ?>" data-nama="<?php echo $nama; ?>" data-source="<?php echo $reward_mhs; ?>" data-toggle="modal" data-target="#view_pencapaian"><?php echo $val['reward']; ?></a></td>
									<td style="text-align: right"><?php echo $transaksi; ?></td>
									<td style="text-align: right"><?php echo $insentif; ?></td>
									<?php
									if ($admfield) {
				...
				<div class="box-footer">
					<div class="alert alert-info">
						...
						<?php if (
							...
							4. Klik tombol <span class="label label-success">Sinkronisasi</span> untuk update data terbaru H-1 per hari 1x klik. (Last Sync: <?php if ($kar_data['kar_sync_date'] !== "00-00-00 00:00:00") {
																																									echo "<strong>" . $kar_data['kar_sync_date'] . "</strong>";
																																								} ?>)
						<?php } ?>
					</div>
				</div>
