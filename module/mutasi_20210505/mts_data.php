<?php 
 require('module/mutasi/mts_act.php'); 
...
!-->					
				...
				<div class="bfh-selectbox" data-name="fpk_jabatan1" 
					data-value="<?php echo $kar_jbt['jbt_id'];?>" data-filter="true" 
				 	style="width:70%; "  >						
						<div data-value=""></div>
						<?php
							if($jbt_tampil){
...
!-->					
				<div class="bfh-selectbox" data-name="fpk_divisi1" 
				data-value="<?php echo $kar_jbt['div_id'];?>" data-filter="true" 
				 style="width:70%; "  >
						<div data-value=""></div>
						<?php
							if($div_tampil){
...
!-->					
				<div class="bfh-selectbox" data-name="fpk_level1" 
					data-value="<?php echo $kar_jbt['lvl_id'];?>" data-filter="true" 
				 	style="width:70%; "  >
						<div data-value=""></div>
						<?php
							if($lvl_tampil){
...
<!--				
					<div >
						<b><?php //echo $kar_jbt['ktr_nm'];?></b>
					</div>
!-->					
				<div class="bfh-selectbox" data-name="fpk_ktr1" 
				 data-value="<?php echo $kar_jbt['ktr_id'];?>" data-filter="true" 
				 style="width:70%; "  >
						<div data-value=""></div>
						<?php
							if($ktr_tampil){
		  ...
		  <div id="aspek_2<?php //echo $fpk_data_asp['fpk_asp_id']; ?>" 
		    ...
		    <div class="panel-body">
			  ...
			  <tr >
			    ...
			    <td width="">
				<div class="bfh-selectbox" data-name="fpk_jabatan2" 
				data-value="<?php echo $kar_jbt['jbt_id'];?>" data-filter="true" 
				 style="width:70%; "  >
						<div data-value=""></div>
						<?php
			  ...
			  <tr>
			    ...
			    <td>
				<div class="bfh-selectbox" data-name="fpk_divisi2" 
				data-value="<?php echo $kar_jbt['div_id'];?>" data-filter="true" 
				 style="width:70%; "  >
						<div data-value=""></div>
						<?php
			  ...
			  <tr>
			    ...
			    <td>
				<div class="bfh-selectbox" data-name="fpk_level2" 
				data-value="<?php echo $kar_jbt['lvl_id'];?>" data-filter="true" 
				 style="width:70%; "  >
						<div data-value=""></div>
						<?php
			  ...
			  <tr>
			    ...
			    <td >
				<div class="bfh-selectbox" data-name="fpk_ktr2" 
				 data-value="<?php echo $kar_jbt['ktr_id'];?>" data-filter="true" 
				 style="width:70%; "  >
						<div data-value=""></div>
						<?php
