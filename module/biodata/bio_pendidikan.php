              ...
              <table id="tb_karyawan" class="table table-bordered table-striped table-hover">
				...
				?>
                  ...
                  <tr>
                    ...
                    data-pddlokasi="<?php echo $data['pdd_lokasi']; ?>" data-toggle="modal" data-target="#pdd_edt" title="Edit Pendidikan"><span style="cursor:pointer" class="label label-primary"><i class="fa fa-ellipsis-h"></i></span></a>
