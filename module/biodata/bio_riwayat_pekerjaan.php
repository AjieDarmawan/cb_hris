              ...
              <table id="tb_karyawan" class="table table-bordered table-striped table-hover">
				...
				?>
                  ...
                  <tr>
                    ...
                    <a href="javascript:;"
                    data-rwpid="<?php echo $data['rwp_id']; ?>"
                    data-rwpjbt="<?php echo $data['rwp_jbt']; ?>"
                    data-rwplvl="<?php echo $data['rwp_lvl']; ?>"
                    data-rwppenghasilan="<?php echo $data['rwp_penghasilan']; ?>"
                    data-rwpperusahaan="<?php echo $data['rwp_perusahaan']; ?>"
                    data-rwpalt="<?php echo $data['rwp_alt']; ?>"
                    data-rwpstart="<?php echo $data['rwp_start']; ?>"
                    data-rwpend="<?php echo $data['rwp_end']; ?>"
                    data-rwpberhenti="<?php echo $data['rwp_berhenti']; ?>" data-toggle="modal" data-target="#rwp_edt" title="Edit Riwayat Pekerjaan"><span style="cursor:pointer" class="label label-primary"><i class="fa fa-ellipsis-h"></i></span></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="bsave_riwayat_pekerjaan" class="btn btn-primary"><i class="fa fa-save"></i></button>
...
<div class="modal fade" id="rwp_edt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header bg-primary">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-briefcase"></i> Edit Riwayat Pekerjaan</h4>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="bupdate_riwayat_pekerjaan" class="btn btn-primary"><i class="fa fa-save"></i></button>
