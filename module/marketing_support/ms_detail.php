    ...
    <section class="content"> 
      ...
      <div class="row">
        <!-- left column -->
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        ?>
                        <input type="radio" name="kar_dtl_typ_krj" value="Freelance" class="flat-red" id="freelance" <?php echo $checked_freelance;?>/> Freelance &nbsp;
		    ...
		    <div class="form-group">
                      <label for="kar_dtl_apv_krj" class="col-sm-2 control-label">Sts Approval</label>
                      <div class="col-sm-10">
                        <select class="form-control" name="kar_dtl_apv_krj" id="kar_dtl_apv_krj" disabled>
                        <?php 
                        if($kar_data_detail['kar_dtl_apv_krj']=="Proses"){
                          $selected_proses="selected";
                        }elseif($kar_data_detail['kar_dtl_apv_krj']=="Diterima"){
                          $selected_diterima="selected";
                        }elseif($kar_data_detail['kar_dtl_apv_krj']=="Gagal"){
                          $selected_gagal="selected";
                        }else{
                          $selected_proses="selected";
                        }
                        ?>
                            <option value="Proses" <?php echo $selected_proses;?>>Proses</option>
                            <option value="Diterima" <?php echo $selected_diterima;?>>Diterima</option>
			    <option value="Gagal" <?php echo $selected_gagal;?>>Gagal</option>
                        </select>
                      </div>
                    </div>
		    <div class="form-group">
                      <label for="kar_dtl_btc_krj" class="col-sm-2 control-label">Batch</label>
                      <div class="col-sm-10">
                        <select class="form-control" name="kar_dtl_btc_krj" id="kar_dtl_btc_krj" disabled>
                        <?php 
                        for($i=0;$i<=20;$i++){
			  if($i == $kar_data_detail['kar_dtl_btc_krj']){
			    $selected_batch = "selected";
			  }else{
			    $selected_batch = "";
			  }
                        ?>
                            <option value="<?php echo $i;?>" <?php echo $selected_batch;?>><?php echo $i;?></option>
			<?php }?>
                        </select>
                      </div>
                    </div>
		    <div class="form-group">
                      <label for="kar_dtl_mem_krj" class="col-sm-2 control-label">Member</label>
                      <div class="col-sm-10">
                        <select class="form-control" name="kar_dtl_mem_krj" id="kar_dtl_mem_krj" disabled>
                        <?php 
                        if($kar_data_detail['kar_dtl_mem_krj']=="External"){
                          $selected_ex="selected";
                        }elseif($kar_data_detail['kar_dtl_mem_krj']=="Internal"){
                          $selected_in="selected";
                        }else{
                          $selected_ex="selected";
                        }
                        ?>
                            <option value="External" <?php echo $selected_ex;?>>External</option>
                            <option value="Internal" <?php echo $selected_in;?>>Internal</option>
                        </select>
                      </div>
                    </div>
		    <div class="form-group">
                      <label for="kar_dtl_tgl_res" class="col-sm-2 control-label">Tgl Resign</label>
                      <div class="col-sm-10">
                        <?php 
                        ...
                        ?>
                        <input type="text" name="kar_dtl_tgl_res" value="<?php echo $kar_dtl_tgl_res;?>" class="form-control" id="kar_dtl_tgl_res" placeholder="Tanggal Resign" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask disabled>
                      </div>
                    </div>
					<div class="form-group">
                      <label for="kar_dtl_als_res" class="col-sm-2 control-label">Alasan Resign</label>
                      <div class="col-sm-10">
                        <textarea name="kar_dtl_als_res" class="form-control" id="kar_dtl_als_res" placeholder="Alasan Resign"  disabled><?php echo $kar_data_detail['kar_dtl_als_res'];?></textarea>
                      </div>
                    </div>
                  </div><!-- /.box-body -->
