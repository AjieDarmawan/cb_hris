...
<!-- POPUP -->
 ...
 <div class="modal fade" id="modal-pengajuan-kasbon-opr" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="modal-body">
				...
				<form role="form" id="pengajuan_kasbon_opr">
					...
					<div class="box-footer">
						...
						<input type="hidden" name="mode" value="simpan_opt">
...
//  alert(urut+' -> '+harga);
  ...
  if (kdbrg=="000"){
	  var x = document.getElementById("harga_"+urut).readOnly = false; 
	  var y = document.getElementById("nmbrg_"+urut).readOnly = false; 
//	  var y = document.getElementById("nmbrg_"+urut).value=""; 
  }else{
	  var x = document.getElementById("harga_"+urut).readOnly = true; 
	  var y = document.getElementById("nmbrg_"+urut).readOnly = true; 
  }	  
