              ...
              <table id="tb_user" class="table table-bordered table-striped table-hover">
                ...
                ?>        
                  ...
                  <tr>
                    ...
                    <td><?php echo $rkm_data_kar['rkm_pelapor']; ?></td>
          ...
          <div class="form-group">
            ...
            <?php
             ...
             ?>
              ...
              <input type="number" name="kkn_kontrak" class="form-control" id="kkn_kontrak" placeholder="" style="width:15%" onkeypress="return onlyNumbers(event);" maxlength = "1" min = "<?php echo $jml_kontrak;?>" max = "3" required>
	  ...
	  <!-- Main content -->
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-6">
		    ...
		    <select class="form-control" name="fpk_priode" id="fpk_priode" style="width:171px;" required>
