	              ...
	              <tbody>
	                  ...
	                  foreach($kar_tampil as $data){
	                      ...
	                      if($data['kar_id']==$absensidtl[$data['kar_id']]["kar_id"]){
	                        ...
	                        $jwd_tampil_now=$jwd->jwd_tampil_now($date,$kar_id_,$kemarin);
	                ...
	                <tr>
	                  ...
	                  <td class="info">
	                    ...
	                    <input type="radio" value="H" name="abs_dtl_sts<?php echo $i;?>"  <?php echo $check_hadir;?> />
	                  </td>
	                  <td class="warning">
	                    <input type="radio" value="I" name="abs_dtl_sts<?php echo $i;?>"  <?php echo $check_izin;?> />
	                  </td>
	                  <td class="success">
	                    <input type="radio" value="S" name="abs_dtl_sts<?php echo $i;?>"  <?php echo $check_sakit;?> />
	                  </td>
	                  <td class="danger">
	                    <input type="radio" value="A" name="abs_dtl_sts<?php echo $i;?>"  <?php echo $check_alpa;?> />
	                  </td>
	                  <td class="danger">
	                    <input type="radio" value="L" name="abs_dtl_sts<?php echo $i;?>"  <?php echo $check_libur;?> />
	                  </td>
	                  <td class="danger">
	                    <input type="radio" value="C" name="abs_dtl_sts<?php echo $i;?>"  <?php echo $check_cuti;?> />
	                  </td>                        
	                </tr>
	              <?php $i++;}}?>  
	              </tbody>      
