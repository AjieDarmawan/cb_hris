...
if(isset($_POST['babsmasuk'])){
				$time_test=date('H:i:s');
				//check point//
				$chc_nik = $_POST['chc_nik'];
				$chc_nm = $_POST['chc_nama'];
				$latlong = $_POST['latitudepost']."#".$_POST['longitudepost'];
				$status_radius = $_POST['status_radius'];
				$jarak = $_POST['jarak'];
				//check point//
				...
				//$akhir = date('H:i', strtotime('+9 minutes', strtotime($waktu_jam_menit)));
				//Range Pagi
				...
				if ($shift == "Shift Pagi"){
					...
					$abs_shift="Shift Pagi";
						if($waktu_jam_menit > $jam_telat_pagi){
							$abs_rwd_masuk="Telat";
                                                        $abs_point=30;
							$abs_masuk=$abt->abs_masuk_telat($abs_masuk,$abs_ip,$abs_tgl_masuk,$abs_alasan_masuk,$abs_shift,$abs_rwd_masuk,$abs_point,$kar_idtst);
							$chc_insert_masuk=$chc->chc_insert_masuk($abs_tgl_masuk, $chc_nik, $chc_nm, $time_test, $latlong, $status_radius, $location, $jarak, $kar_idtst);
						//echo "<script type='text/javascript'>alert('$abs_rwd_masuk');</script>";
                                                        //Notify
						...
						elseif($waktu_jam_menit < $jam_tepat_pagi){//UPDATE GANTI VARIABEL
							$abs_rwd_masuk="Rajin";
                                                        $abs_point=80;
							$abs_masuk=$abt->abs_masuk($abs_masuk,$abs_ip,$abs_tgl_masuk,$abs_shift,$abs_rwd_masuk,$abs_point,$kar_idtst);
							$chc_insert_masuk=$chc->chc_insert_masuk($abs_tgl_masuk, $chc_nik, $chc_nm, $time_test, $latlong, $status_radius, $location, $jarak, $kar_idtst);
						//echo "<script type='text/javascript'>alert('$abs_rwd_masuk');</script>";
                                                        //Notify
							// $ntf_id=mysql_insert_id();
					...
					$abs_shift="Shift Siang";
						if($waktu_jam_menit > $jam_telat_siang){
							...
							$abs_masuk=$abt->abs_masuk_telat($abs_masuk,$abs_ip,$abs_tgl_masuk,$abs_alasan_masuk,$abs_shift,$abs_rwd_masuk,$abs_point,$kar_idtst);
							$chc_insert_masuk=$chc->chc_insert_masuk($abs_tgl_masuk, $chc_nik, $chc_nm, $time_test, $latlong, $status_radius, $location, $jarak, $kar_idtst);
						//echo "<script type='text/javascript'>alert('$abs_rwd_masuk.$kar_idtst');</script>";
                                                        //Notify
							// $ntf_id=mysql_insert_id();
                                                        // $ntf_act="Absen Masuk";
                                                        // $ntf_isi=$ntf_id.'-'.$abs_shift.'-'.$abs_rwd_masuk.'-'.$abs_point.'-'.$abs_alasan_masuk;
						...
						elseif($waktu_jam_menit < $jam_tepat_siang){ //UPDATE GANTI VARIABEL
							$abs_rwd_masuk="Rajin";
                                                        $abs_point=80;
							$abs_masuk=$abt->abs_masuk($abs_masuk,$abs_ip,$abs_tgl_masuk,$abs_shift,$abs_rwd_masuk,$abs_point,$kar_idtst);
							$chc_insert_masuk=$chc->chc_insert_masuk($abs_tgl_masuk, $chc_nik, $chc_nm, $time_test, $latlong, $status_radius, $location, $jarak, $kar_idtst);
				...
				if($abs_masuk){
					...
					$abs_dtl_tgl=$date;
					$abs_dtl_sts="H";
					$abs_dtl_tampil=$abt->abs_dtl_tampil($kar_idtst,$abs_dtl_tgl);
				  	$abs_dtl_cek=mysql_num_rows($abs_dtl_tampil);
					if($abs_dtl_cek > 0){
						$abs_dtl_update=$abt->abs_dtl_update($abs_dtl_tgl,$abs_dtl_sts,$kar_idtst);
					}else{
						//$abs_dtl_insert=$abt->abs_dtl_insert($abs_dtl_tgl,$abs_dtl_sts,$kar_id);
						$abs_dtl_insert=$abt->abs_dtl_insert_full($abs_dtl_tgl,$abs_dtl_sts,$abs_dtl_type,$location,$kar_idtst);
					}
					...
					$kar_update_location=$kar->kar_update_location($kar_idtst,$ktr_id_,$unt_id_);
...
elseif(isset($_POST['checkpoint2post'])){
	...
	$jarak = $_POST['jarak'];
	//check point 2//
	$chc_update_checkpoint2=$chc->chc_update_checkpoint2($abs_tgl_masuk, $time_test, $latlong, $status_radius, $jarak, $kar_idtst);
	echo "<script>alert('THANKS');document.location='media.php';</script>";
}
elseif(isset($_POST['checkpoint3post'])){
	...
	$jarak = $_POST['jarak'];
	//check point 23//
	$chc_update_checkpoint3=$chc->chc_update_checkpoint3($abs_tgl_masuk, $time_test, $latlong, $status_radius, $jarak, $kar_idtst);
	echo "<script>alert('THANKS');document.location='media.php';</script>";
}
?>