		  ...
		  <div id="aspek_5<?php //echo $fpk_data_asp['fpk_asp_id']; ?>" 
		    ...
		    <div class="panel-body">
			  ...
			  <tr>
			    <td width="30%">
					<div >
					<i class="fa fa-check-square-o"></i> Pemohon </div>
				</td>
			  ...
			  <tr>
			    <td width="30%">
					<div >
					<i class="fa fa-check-square-o"></i> Menyetujui 1 </div>
				</td>
			  ...
			  <tr>
			    <td width="30%">
					<div >
					<i class="fa fa-check-square-o"></i> Menyetujui 2 </div>
				</td>
			  ...
			  <tr>
			    <td width="30%">
					<div >
					<i class="fa fa-check-square-o"></i> Mengetahui </div>
				</td>
...
<!-------------------------------------------------------------------!-->
        ...
        ?>
		  ...
		  <div class="form-group"  >
		    <label for="fpk_tgl" class="col-sm-9 control-label " style="text-align:right">
			 Efektif  diberlakukan sejak tanggal :
			</label>
		    <div class="col-sm-3">
			  <?php 
			    $tgl_berlaku = "";
			  ...
			  ?> 
		      <input type="text" name="fpk_tgl" class="form-control " id="fpk_tgl"
			   value="<?php  echo $tgl_berlaku;?>" placeholder="Tgl berlaku" 
			   data-inputmask="'alias': 'yyyy-mm-dd'" 
			   data-mask style="width:182;" required <?php echo $disabled;?> >
	
		    </div>
		  </div>
		  <div align="right">
		  	
			  <?php echo 'Bogor, '.date('d-m-Y ',strtotime($tgl_berlaku)) ;?><br />
			  Disetujui Oleh : <b><?php echo $fpk_data_mengetahui['kar_nm'] ;?></b>
		  </div>		  		  
		   <hr />	  
	  ...
	  <div class="row no-print">
		<div class="col-xs-12">
	      ...
	      <button type="submit" name="bapproved" class="btn btn-success pull-right" <?php echo $done;?>>
		  	<i class="fa fa-thumbs-up"></i> Approved 
		  </button>

	      <?php }else{?>

	      <button type="submit" name="bapproved"  onclick="return confirm('Apakah Setuju ?...  ')" 
		    class="btn btn-success pull-right" <?php echo $konfirm;?> >
		  	<i class="fa fa-thumbs-up"></i> Approved 
		  </button>
