...
$ch = curl_init(); 
curl_setopt($ch, CURLOPT_URL, "https://api.p2k.co.id/kampus/list-min?length=1000");
...
if(isset($_GET['rowdata']) && $_GET['rowdata'] == '1') {
	...
	$row_pencapaian .= '	<td class="text-center text-white" colspan="2">Total Alih Fungsi</td>';
	...
	$row_pencapaian .= '	<td class="text-center text-white" colspan="2">Total CS</td>';
	...
	$row_pencapaian .= '	<td class="text-center text-white" colspan="2">Total Sekretariat</td>';
	...
	$row_pencapaian .= '	<td class="text-center text-white" colspan="2">Total Keseluruhan</td>';
        ...
        <div class="container-fluid p-0 p-lg-2">
            <nav class="navbar navbar-expand-md navbar-dark heading bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
					...
					<select class="form-control col-md-3 mr-md-2 mt-2 mt-md-0" onchange="reload_data(this);">
					...
					<select class="form-control col-md-3 mr-md-2 mt-2 mt-md-0" onchange="gotosite(this);">
						<option value="kampus" selected>Pencapaian Per-Kampus</option>
						<option value="karyawan">Pencapaian Per-Karyawan</option>
					</select>
					<script>
						function gotosite(e) {
							if(e.value == 'kampus') {
