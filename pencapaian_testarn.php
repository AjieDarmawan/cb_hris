...
$allowed_order = array("nama"=>"txt","total"=>"num");
...
foreach($arr_row as $k => $v) {
	...
	$row_print .= '
		<tr class="sticky-top heading sticky-sub-offset">
			<th class="bg-danger" colspan="'. ($head_colspan + 2).'">
				<h5>'.$v['label'].'</h5>
			</th>
		</tr>
	';
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-3 mt-2 mt-md-0">
                            ...
                            <select class="form-control  w-100" onchange="gotosite(this);">																<option value="karyawan <?php echo $select_def; ?>">Per-Karyawan</option>
