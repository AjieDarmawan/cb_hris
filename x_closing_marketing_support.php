...
$page = "closing_marketing_support.php";
...
$groupAlias = array('MS'=>'Marketing Support');

$dataArr=array();
$groupArr=array();

$sql = "SELECT rwd_nik, rwd_nm, rwd_div, SUM(rwd_jumlah1) AS jumlah, rwd_tanggal
FROM ( SELECT * FROM `rwd_data_ms` WHERE rwd_div LIKE '%_MS%' AND rwd_tanggal BETWEEN '".$r_awal_ori."' AND '".$r_sekarang_ori."'
)
