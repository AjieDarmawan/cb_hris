...
foreach($karyawanArr as $data){
    ...
    if($nrw_cek_jml == 0){
        $nrw_insert_cs = $nrw->nrw_insert_cs($nrw_priode,$nrw_cutoff,$nrw_nik,$nrw_nama,$nrw_tcm,$nrw_jml_pmb,$nrw_jml_reg,$nrw_jml_her,$nrw_data,$nrw_normal_data,$nrw_libur_data,$nrw_incase_data,$nrw_closing_rp25,$nrw_closing_rp50,$nrw_reward_reg,$nrw_reward_her,$nrw_insentif);
    }
}
?>