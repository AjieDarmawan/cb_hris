...
$r_awal_ori = "2020-06-09";
$r_sekarang_ori = "2020-06-09";

//$r_awal_ori = $date1;
//$r_sekarang_ori = $date2;

$username = "MS.0002.2020";
//$username = $_POST['nik'];

$kar_tampil_div_in = $ms->ms_tampil_nik($username);
...
$kar_sync_update = $ms->ms_sync_update($username,$datetime);
?>